...
public class VoicePlayingIcon extends View {
    ...
    public VoicePlayingIcon(Context context, AttributeSet attrs) {
        this(context, attrs ,0);
    }

    public VoicePlayingIcon(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        pointerNum = ta.getInt(R.styleable.voisePlayingIconAttr_pointer_num, 3);
        pointerWidth = DensityUtils.dp2px(getContext(),3f);
