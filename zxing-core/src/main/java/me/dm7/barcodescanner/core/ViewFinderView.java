...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private boolean mIsScanTipsEnabled;
    ...
    @Override
    public void setScanTipsEnabled(boolean isTipsEnabled) {
        mIsScanTipsEnabled = isTipsEnabled;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mIsScanTipsEnabled) {
            drawViewFinderDesc(canvas);
        }
    ...
    public void drawViewFinderDesc(Canvas canvas) {
        final Rect framingRect = getFramingRect();
        int y = framingRect.bottom + dpToPx(56);
        String text = "将设备显示的二维码放入框内，即可自动扫描";
    ...
    public synchronized void updateFramingRect() {
        ...
        mFramingRect = new Rect(leftOffset + mViewFinderOffset, dpToPx(128), //暂时写死高度
