...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    private boolean mScanTipsEnabled = false;
    @ColorInt
    ...
    public void setViewFinderOffset(int offset) {
        ...
        mViewFinderView.setViewFinderOffset(offset);
    }
    ...
    public void setScanTipsEnabled(boolean isTipsEnabled) {
        mScanTipsEnabled = isTipsEnabled;
        mViewFinderView.setScanTipsEnabled(mScanTipsEnabled);
        mViewFinderView.setupViewFinder();
    }
